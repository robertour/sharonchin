 ...
 * @since		1.5.0 - 06.05.2012
 */

class SiteMap_Nav_Walker extends Walker_Nav_Menu {
...
class SharonChin_Nav_Walker extends Walker_Nav_Menu {
 ...
 * @return	array
 */
function sharonchin_nav_menu_css_class( $classes ) {
	if ( in_array('current-menu-item', $classes ) OR in_array( 'current-menu-ancestor', $classes ) )
		$classes[]	=	'active';

	return $classes;
}
add_filter( 'nav_menu_css_class', 'sharonchin_nav_menu_css_class' );


/* End of file nav-menu-walker.php */
/* Location: ./wp-content/themes/sharonchin/inc/nav-menu-walker.php */

...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'well' ); ?>>
	...
	<div class="entry-content row">
		<div class="thumbnail avatar span1"><?php echo get_avatar( get_the_author_meta( 'email' ), apply_filters( 'sharonchin_status_avatar', 70 ) ); ?></div>
		<div class="offset1">
			<?php
...
/* Location: ./wp-content/themes/sharonchin/partials/content-status.php */